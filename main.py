...
def main():
    ...
    job_queue.run_daily(api.deliver_reddit_subscriptions, time=datetime.time(18, 30))
    job_queue.run_daily(api.deliver_reddit_subscriptions, time=datetime.time(6, 30))
